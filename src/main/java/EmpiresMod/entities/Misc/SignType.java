...
public abstract class SignType {
	 ...
	 * 
	 * @param tileEntity
	 *            The tile entity that is being loaded
	 * @param signData
	 *            The data stored on the sign
	 * @return The loaded sign
	 */
	public abstract Sign loadData(TileEntitySign tileEntity, NBTBase signData);

	/**
	 * Register this type on the {@link SignManager}, all types must be
	 * registered to be recognized.
	 */

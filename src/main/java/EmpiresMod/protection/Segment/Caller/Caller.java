...
import EmpiresMod.protection.Segment.Caller.reflectasm.ASMCallerField;
import EmpiresMod.protection.Segment.Caller.reflectasm.ASMCallerMethod;
...
public abstract class Caller {
	...
	public static class Serializer extends SerializerTemplate<Caller> {
		...
		@Override
		public Caller deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)

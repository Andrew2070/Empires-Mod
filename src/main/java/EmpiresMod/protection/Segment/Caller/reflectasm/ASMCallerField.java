package EmpiresMod.protection.Segment.Caller.reflectasm;

import com.esotericsoftware.reflectasm.FieldAccess;

import EmpiresMod.Empires;
import EmpiresMod.protection.Segment.Caller.reflect.ReflectCallerField;
...
public class ASMCallerField extends ReflectCallerField {
	...
	public Object invoke(Object instance, Object... parameters) throws Exception {
		// Fallback to reflection in-case ReflectASM can't get to the field for
		// whatever reason
		if (index == -1) {
	...
	public void setClass(Class<?> clazz) {
		...
		try {
			...
			Empires.instance.LOG.debug(name + " - Falling back to reflection based field caller", ex);
			index = -1;
		}
	}
}
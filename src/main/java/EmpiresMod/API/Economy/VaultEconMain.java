package EmpiresMod.API.Economy;
...
public interface VaultEconMain {
	...
	/**
	 *
	 * @deprecated As of Vault 1.3.01 use {@link #hasAccount(OfflinePlayer)}
	 *             instead.
	 *
	 *             Checks if this player has an account on the server yet This
	 *             will always return true if the player has joined the server
	 *             at least once as all major economy plugins auto-generate a
	...
	/**
	 * @deprecated As of Vault 1.3.01 use
	 *             {@link #hasAccount(OfflinePlayer, String)} instead.
	 *
	 *             Checks if this player has an account on the server yet on the
	 *             given world This will always return true if the player has
	 *             joined the server at least once as all major economy plugins
	...
	/**
	 * @deprecated As of Vault 1.3.01 use {@link #getBalance(OfflinePlayer)}
	 *             instead. Gets balance of a player
	 *
	 * @param playerName
	 *            of the player
	...
	/**
	 * @deprecated As of Vault 1.3.01 use {@link #has(OfflinePlayer, double)}
	 *             instead.
	 *
	...
	/**
	 * @deprecated As of Vault 1.3.01 use @{link
	 *             {@link #has(OfflinePlayer, String, double)} instead.
	 *
	 *             Checks if the player account has the amount in a given world
	 *             - DO NOT USE NEGATIVE AMOUNTS IMPLEMENTATION SPECIFIC - if an
	 *             economy plugin does not support this the global balance will
	 *             be returned.
	 *
	 * @param playerName
	 *            to check
	 ...
	 *             Withdraw an amount from a player - DO NOT USE NEGATIVE
	 *             AMOUNTS
	 *
	 * @param playerName
	 *            Name of player
	 ...
	 *             USE NEGATIVE AMOUNTS IMPLEMENTATION SPECIFIC - if an economy
	 *             plugin does not support this the global balance will be
	 *             returned.
	 * @param playerName
	 *            Name of player
	 * @param worldName
	 ...
	 *
	 *             Creates a bank account with the specified name and the player
	 *             as the owner
	 * @param name
	 *            of account
	 * @param player
	 ...
	 *             the specified world IMPLEMENTATION SPECIFIC - if an economy
	 *             plugin does not support this the global balance will be
	 *             returned.
	 * @param playerName

...
import EmpiresMod.API.Chat.Component.ChatComponentHelpMenu;
...
import EmpiresMod.entities.Permissions.TreeNode;
...
/**
 * The declaration is a bit difficult to understand. It means that the super
 * class "TreeNode" should work with other "CommandTreeNode" objects.
 */

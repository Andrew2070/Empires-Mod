...
public class ColorUtils {
    ...
    public static final ChatStyle styleEmpire = new ChatStyle().setColor(EnumChatFormatting.GOLD);
    public static final ChatStyle styleSelectedEmpire = new ChatStyle().setColor(EnumChatFormatting.GREEN);

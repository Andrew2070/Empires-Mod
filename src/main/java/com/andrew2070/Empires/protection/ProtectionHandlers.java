package com.andrew2070.Empires.protection;
...
import com.andrew2070.Empires.Events.AE2PartPlaceEvent;
import com.andrew2070.Empires.Events.BlockTrampleEvent;
import com.andrew2070.Empires.Events.ModifyBiomeEvent;
import com.andrew2070.Empires.Events.ModifyBlockEvent;
import com.andrew2070.Empires.Events.ProjectileImpactEvent;
...
import com.andrew2070.Empires.Thread.ThreadPlacementCheck;
...
public class ProtectionHandlers {
    ...
    public void worldTick(TickEvent.WorldTickEvent ev) {
        ...
        //Empires.instance.LOG.info("Tick number: " + MinecraftServer.getServer().getTickCounter());
        ...
        for (int i = 0; i < loadedEntityListSize; i++) {
            ...
            Empire empire = EmpireUtils.getEmpireAtPosition(entity.dimension, (int) Math.floor(entity.posX) >> 4, (int) Math.floor(entity.posZ) >> 4);

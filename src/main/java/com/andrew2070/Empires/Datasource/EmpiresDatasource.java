...
import com.andrew2070.Empires.Datasource.DatasourceSQL;
import com.andrew2070.Empires.Datasource.API.EmpiresSchema;
...
import com.andrew2070.Empires.entities.Empire.Bank;
...
import com.andrew2070.Empires.Misc.Teleport.Teleport;
    ...
    public boolean saveEmpire(Empire empire) {
        ...
        try {
            if (getUniverse().empires.contains(empire)) { // Update
                ...
                PreparedStatement insertStatement = prepare("INSERT INTO " + prefix + "Empires (name, spawnDim, spawnX, spawnY, spawnZ, cameraYaw, cameraPitch, isAdminEmpire, extraBlocks, maxPlots, extraFarClaims) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", true);

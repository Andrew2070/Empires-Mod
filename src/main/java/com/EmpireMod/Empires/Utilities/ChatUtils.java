...
public class ChatUtils {
	...
	public static void sendChat(ICommandSender sender, String msg, Object... args) {
		...
		try {
			...
			Empires.instance.LOG.error("Failed to send chat message! Message: {}", msg);
		}
	}
	...
	/**
	 * Same as {@link ChatUtils#equalsOn(String, boolean)}, but is not case
	 * sensitive
	 */

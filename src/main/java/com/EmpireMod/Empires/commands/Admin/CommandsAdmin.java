...
public class CommandsAdmin extends CommandsEMP {
	...
	@Command(name = "Empiresadmin", permission = "Empires.adm.cmd", syntax = "/empireadmin <command>", alias = {
			"empadmin", "empireadmin", "eadmin", "Empadmin", "Empireadmin", "Eadmin" })
	public static CommandResponse empireAdminCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "config", permission = "Empires.adm.cmd.config", parentName = "Empires.adm.cmd", syntax = "/empireadmin config <command>", console = true)
	public static CommandResponse configCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "reload", permission = "Empires.adm.cmd.config.reload", parentName = "Empires.adm.cmd.config", syntax = "/empireadmin config reload", console = true)
	...
	@Command(name = "reset", permission = "Empires.adm.cmd.config.reset", parentName = "Empires.adm.cmd.config", syntax = "/empireadmin config reset <command>", console = true)
	public static CommandResponse configResetCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "defaultRanks", permission = "Empires.adm.cmd.config.reset.defaultRanks", parentName = "Empires.adm.cmd.config.reset", syntax = "/empireadmin config reset ranks", console = true)
	...
	@Command(name = "wild", permission = "Empires.adm.cmd.config.reset.wildPerms", parentName = "Empires.adm.cmd.config.reset", syntax = "/empireadmin config reset wild", console = true)
	...
	@Command(name = "defaultFlags", permission = "Empires.adm.cmd.config.reset.defaultFlags", parentName = "Empires.adm.cmd.config.reset", syntax = "/empireadmin config reset defaultFlags", console = true)
	...
	@Command(name = "update", permission = "Empires.adm.cmd.update", parentName = "Empires.adm.cmd", syntax = "/empireadmin update <command>", console = true)
	public static CommandResponse updateCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "ranks", permission = "Empires.adm.cmd.update.ranks", parentName = "Empires.adm.cmd.update", syntax = "/empireadmin update ranks", console = true)
	...
	@Command(name = "add", permission = "Empires.adm.cmd.add", parentName = "Empires.adm.cmd", syntax = "/empireadmin add <citizen> <empire> [rank]", console = true, completionKeys = {
			"citizenCompletion", "empireCompletion" })
	...
	@Command(name = "delete", permission = "Empires.adm.cmd.delete", parentName = "Empires.adm.cmd", syntax = "/empireadmin delete <empire>", console = true, completionKeys = {
			"empireCompletion" })
	...
	@Command(name = "new", permission = "Empires.adm.cmd.new", parentName = "Empires.adm.cmd", syntax = "/empireadmin new <name>")
	...
	@Command(name = "kick", permission = "Empires.adm.cmd.kick", parentName = "Empires.adm.cmd", syntax = "/empireadmin kick <citizen> <empire>", console = true, completionKeys = {
			"citizenCompletion", "empireCompletion" })
	...
	@Command(name = "res", permission = "Empires.adm.cmd.res", parentName = "Empires.adm.cmd", syntax = "/empireadmin res <command>", console = true)
	public static CommandResponse resCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "blocks", permission = "Empires.adm.cmd.blocks", parentName = "Empires.adm.cmd", syntax = "/empireadmin blocks <command>", console = true)
	public static CommandResponse empireBlocksCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "info", permission = "Empires.adm.cmd.blocks.info", parentName = "Empires.adm.cmd.blocks", syntax = "/empireadmin blocks info <empire>", completionKeys = {
			"empireCompletion" }, console = true)
	public static CommandResponse blocksInfoCommand(ICommandSender sender, List<String> args) {
		...
		IChatComponent header = LocalizationManager.get("Empires.format.list.header",
				new ChatComponentFormatted("{9|BLOCKS}"));
		...
		extraBlocksSources.add(LocalizationManager.get("Empires.notification.blocks.info.extra",
				new ChatComponentFormatted("{9|EMPIRE}"), empire.empireBlocksContainer.getExtraBlocks()));
		for (Citizen res : empire.citizensMap.keySet()) {
			extraBlocksSources
					.add(LocalizationManager.get("Empires.notification.blocks.info.extra", res, res.getExtraBlocks()));
		}

		ChatManager.send(sender, "Empires.notification.blocks.info", header, blocks, extraBlocks, extraBlocksSources,
				farBlocks);
		return CommandResponse.DONE;
	}

	@Command(name = "extra", permission = "Empires.adm.cmd.blocks.extra", parentName = "Empires.adm.cmd.blocks", syntax = "/empireadmin blocks extra <command>", console = true)
	public static CommandResponse empireBlocksMaxCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "set", permission = "Empires.adm.cmd.blocks.extra.set", parentName = "Empires.adm.cmd.blocks.extra", syntax = "/empireadmin blocks extra set <empire> <amount>", completionKeys = {
			"empireCompletion" }, console = true)
	public static CommandResponse empireBlocksMaxSetCommand(ICommandSender sender, List<String> args) {
		...
		ChatManager.send(sender, "Empires.notification.empire.blocks.extra.set",
				empire.empireBlocksContainer.getExtraBlocks(), empire);
		return CommandResponse.DONE;
	}

	@Command(name = "powerboost", permission = "Empires.adm.cmd.powerboost", syntax = "/empireadmin powerboost <citizen> <amount>", parentName = "Empires.adm.cmd", completionKeys = {
			"citizenCompletion" }, console = true)
	...
	@Command(name = "add", permission = "Empires.adm.cmd.blocks.extra.add", parentName = "Empires.adm.cmd.blocks.extra", syntax = "/empireadmin blocks extra add <empire> <amount>", completionKeys = {
			"empireCompletion" }, console = true)
	...
	@Command(name = "remove", permission = "Empires.adm.cmd.blocks.extra.remove", parentName = "Empires.adm.cmd.blocks.extra", syntax = "/empireadmin blocks extra remove <empire> <amount>", completionKeys = {
			"empireCompletion" }, console = true)
	...
	@Command(name = "far", permission = "Empires.adm.cmd.blocks.far", parentName = "Empires.adm.cmd.blocks", syntax = "/empireadmin blocks far <command>")
	public static CommandResponse empireBlocksFarClaimsCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "set", permission = "Empires.adm.cmd.blocks.far.set", parentName = "Empires.adm.cmd.blocks.far", syntax = "/empireadmin blocks far set <empire> <amount>", completionKeys = {
			"empireCompletionAndAll" }, console = true)
	public static CommandResponse empireBlocksFarclaimsSetCommand(ICommandSender sender, List<String> args) {
		...
		getDatasource().saveEmpire(empire);
		ChatManager.send(sender, "Empires.notification.empire.blocks.farClaims.set",
				empire.empireBlocksContainer.getExtraFarClaims(), empire);
		return CommandResponse.DONE;
	}

	@Command(name = "add", permission = "Empires.adm.cmd.blocks.far.add", parentName = "Empires.adm.cmd.blocks.far", syntax = "/empireadmin blocks far add <empire> <amount>", completionKeys = {
			"empireCompletionAndAll" }, console = true)
	...
	@Command(name = "remove", permission = "Empires.adm.cmd.blocks.far.remove", parentName = "Empires.adm.cmd.blocks.far", syntax = "/empireadmin blocks far remove <empire> <amount>", completionKeys = {
			"empireCompletionAndAll" }, console = true)
	...
	@Command(name = "blocks", permission = "Empires.adm.cmd.res.blocks", parentName = "Empires.adm.cmd.res", syntax = "/empireadmin res blocks <command>", console = true)
	public static CommandResponse resBlocksCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "extra", permission = "Empires.adm.cmd.res.blocks.extra", parentName = "Empires.adm.cmd.res.blocks", syntax = "/empireadmin res blocks extra <command>", console = true)
	public static CommandResponse resBlocksMaxCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "set", permission = "Empires.adm.cmd.res.blocks.extra.set", parentName = "Empires.adm.cmd.res.blocks.extra", syntax = "/empireadmin res blocks extra set <citizen> <extraBlocks>", completionKeys = {
			"citizenCompletion" }, console = true)
	...
	@Command(name = "add", permission = "Empires.adm.cmd.res.blocks.extra.add", parentName = "Empires.adm.cmd.res.blocks.extra", syntax = "/empireadmin res blocks extra add <citizen> <extraBlocks>", completionKeys = {
			"citizenCompletion" }, console = true)
	...
	@Command(name = "remove", permission = "Empires.adm.cmd.res.blocks.extra.remove", parentName = "Empires.adm.cmd.res.blocks.extra", syntax = "/empireadmin res blocks extra remove <citizen> <extraBlocks>", completionKeys = {
			"citizenCompletion" }, console = true)
	...
	@Command(name = "ranks", permission = "Empires.adm.cmd.ranks", parentName = "Empires.adm.cmd", syntax = "/empireadmin ranks <command>", console = true)
	public static CommandResponse ranksCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "add", permission = "Empires.adm.cmd.ranks.add", parentName = "Empires.adm.cmd.ranks", syntax = "/empireadmin ranks add <empire> <name> [templateRank]", completionKeys = {
			"empireCompletion", "-", "ranksCompletion" }, console = true)
	public static CommandResponse ranksAddCommand(ICommandSender sender, List<String> args) {
		...
		if (empire.ranksContainer.contains(args.get(1))) {
			throw new EmpiresCommandException("Empires.cmd.err.ranks.add.already",
					empire.ranksContainer.get(args.get(1)));
		}

		Rank rank = new Rank(args.get(1), empire, Rank.Type.REGULAR);
		if (args.size() > 2) {
	...
	@Command(name = "remove", permission = "Empires.adm.cmd.ranks.remove", parentName = "Empires.adm.cmd.ranks", syntax = "/empireadmin ranks remove <empire> <rank>", completionKeys = {
			"empireCompletion", "rankCompletion" }, console = true)
	...
	@Command(name = "set", permission = "Empires.adm.cmd.ranks.set", parentName = "Empires.adm.cmd.ranks", syntax = "/empireadmin ranks set <empire> <rank> <type>", completionKeys = {
			"empireCompletion", "rankCompletion" }, console = true)
	...
	@Command(name = "add", permission = "Empires.adm.cmd.ranks.perm.add", parentName = "Empires.adm.cmd.ranks.perm", syntax = "/empireadmin ranks perm add <empire> <rank> <perm>", completionKeys = {
			"empireCompletion", "rankCompletion" }, console = true)
	...
	@Command(name = "remove", permission = "Empires.adm.cmd.ranks.perm.remove", parentName = "Empires.adm.cmd.ranks.perm", syntax = "/empireadmin ranks perm remove <empire> <rank> <perm>", completionKeys = {
			"empireCompletion", "rankCompletion" }, console = true)
	...
	@Command(name = "reset", permission = "Empires.adm.cmd.ranks.reset", parentName = "Empires.adm.cmd.ranks", syntax = "/empireadmin ranks reset <empire>", completionKeys = {
			"empireCompletion" }, console = true)
	...
	@Command(name = "perm", permission = "Empires.adm.cmd.ranks.perm", parentName = "Empires.adm.cmd.ranks", syntax = "/empireadmin ranks perm <command>")
	public static CommandResponse ranksPermCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.adm.cmd.ranks.perm.list", parentName = "Empires.adm.cmd.ranks.perm", syntax = "/empireadmin ranks perm list <empire> <rank>", completionKeys = {
			"empireCompletion", "rankCompletion" })
	...
	@Command(name = "safemode", permission = "Empires.adm.cmd.safemode", parentName = "Empires.adm.cmd", syntax = "/empireadmin safemode <on|off>", console = true)
	...
	@Command(name = "db", permission = "Empires.adm.cmd.db", parentName = "Empires.adm.cmd", syntax = "/empireadmin db <command>", console = true)
	public static CommandResponse dbCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "purge", permission = "Empires.adm.cmd.db.purge", parentName = "Empires.adm.cmd.db", syntax = "/empireadmin db purge", console = true)
	...
	@Command(name = "reload", permission = "Empires.adm.cmd.db.reload", parentName = "Empires.adm.cmd.db", syntax = "/empireadmin db reload", console = true)
	...
	@Command(name = "perm", permission = "Empires.adm.cmd.perm", parentName = "Empires.adm.cmd", syntax = "/empireadmin perm <command>", console = true)
	public static CommandResponse permCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "empire", permission = "Empires.adm.cmd.perm.empire", parentName = "Empires.adm.cmd.perm", syntax = "/empireadmin perm empire <command>", console = true)
	public static CommandResponse permEmpireCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.adm.cmd.perm.empire.list", parentName = "Empires.adm.cmd.perm.empire", syntax = "/empireadmin perm empire list <empire>", completionKeys = {
			"empireCompletion" }, console = true)
	...
	@Command(name = "set", permission = "Empires.adm.cmd.perm.empire.set", parentName = "Empires.adm.cmd.perm.empire", syntax = "/empireadmin perm empire set <empire> <flag> <value>", completionKeys = {
			"empireCompletion", "flagCompletion" }, console = true)
	public static CommandResponse permEmpireSetCommand(ICommandSender sender, List<String> args) {
		...
		if (!flag.flagType.configurable && (playerSender == null
				|| !PermissionProxy.getPermissionManager().hasPermission(playerSender.getPersistentID(),
						"Empires.adm.cmd.perm.empire.set." + flag.flagType + ".bypass"))) {
	...
	@Command(name = "toggle", permission = "Empires.adm.cmd.perm.empire.toggle", parentName = "Empires.adm.cmd.perm.empire", syntax = "/empireadmin perm empire toggle <empire> <flag>", completionKeys = {
			"empireCompletion", "flagCompletion" }, console = true)
	public static CommandResponse permEmpireToggleCommand(ICommandSender sender, List<String> args) {
		...
		if (!flag.flagType.configurable && (playerSender == null
				|| !PermissionProxy.getPermissionManager().hasPermission(playerSender.getPersistentID(),
						"Empires.adm.cmd.perm.empire.toggle." + flag.flagType + ".bypass"))) {
			throw new EmpiresCommandException("Empires.cmd.err.flag.unconfigurable", args.get(1));
		} else {
			if (flag.toggle()) {
				ChatManager.send(sender, "Empires.notification.perm.success");
	...
	@Command(name = "whitelist", permission = "Empires.adm.cmd.perm.empire.whitelist", parentName = "Empires.adm.cmd.perm.empire", syntax = "/empireadmin perm empire whitelist <empire>", completionKeys = {
			"empireCompletion" })
	...
	@Command(name = "wild", permission = "Empires.adm.cmd.perm.wild", parentName = "Empires.adm.cmd.perm", syntax = "/empireadmin perm wild <command>", console = true)
	public static CommandResponse permWildCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.adm.cmd.perm.wild.list", parentName = "Empires.adm.cmd.perm.wild", syntax = "/empireadmin perm wild list", completionKeys = {
			"flagCompletion" }, console = true)
	...
	@Command(name = "set", permission = "Empires.adm.cmd.perm.wild.set", parentName = "Empires.adm.cmd.perm.wild", syntax = "/empireadmin perm wild set <flag> <value>", completionKeys = {
			"flagCompletion" }, console = true)
	...
	@Command(name = "toggle", permission = "Empires.adm.cmd.perm.wild.toggle", parentName = "Empires.adm.cmd.perm.wild", syntax = "/empireadmin perm wild toggle <flag>", completionKeys = {
			"flagCompletion" }, console = true)
	...
	@Command(name = "claim", permission = "Empires.adm.cmd.claim", parentName = "Empires.adm.cmd", syntax = "/empireadmin claim <empire> [range]", completionKeys = {
			"empireCompletion" })
	public static CommandResponse claimCommand(ICommandSender sender, List<String> args) {
		...
		if (args.size() < 2) {
			...
			if (!CommandsOfficer.checkNearby(player.dimension, player.chunkCoordX, player.chunkCoordZ, empire)) { // Checks
																													// if
																													// the
																													// player
																													// can
			...
			EmpireBlock block = getUniverse().newBlock(player.dimension, player.chunkCoordX, player.chunkCoordZ,
					isFarClaim, 0, empire);
			if (block == null) {
				throw new EmpiresCommandException("Empires.cmd.err.claim.failed");
			}
			getDatasource().saveBlock(block);
			ChatManager.send(sender, "Empires.notification.block.added", block.getX() * 16, block.getZ() * 16,
					block.getX() * 16 + 15, block.getZ() * 16 + 15, empire);
		} else {

			checkPositiveInteger(args.get(1));

			int radius = Integer.parseInt(args.get(1));
			List<ChunkPos> chunks = WorldUtils.getChunksInBox(player.dimension, (int) (player.posX - radius * 16),
					(int) (player.posZ - radius * 16), (int) (player.posX + radius * 16),
			...
			for (ChunkPos chunk : chunks) {
				EmpireBlock block = getUniverse().newBlock(player.dimension, chunk.getX(), chunk.getZ(), isFarClaim, 0,
						empire);
				// Just so that only one of the blocks will be marked as far
				// claim.
				isFarClaim = false;
				getDatasource().saveBlock(block);
				ChatManager.send(sender, "Empires.notification.block.added", block.getX() * 16, block.getZ() * 16,
	...
	@Command(name = "chunkload", permission = "Empires.adm.cmd.claim.chunkload", parentName = "Empires.adm.cmd.claim", syntax = "/empireadmin claim chunkload")
	...
	@Command(name = "chunkunload", permission = "Empires.adm.cmd.claim.chunkunload", parentName = "Empires.adm.cmd.claim", syntax = "/empireadmin claim chunkunload")
	...
	@Command(name = "all", permission = "Empires.adm.cmd.claim.chunkload.all", parentName = "Empires.adm.cmd.claim.chunkload", syntax = "/empireadmin claim chunkload all <empire>", completionKeys = {
			"empireCompletion" })
	...
	@Command(name = "all", permission = "Empires.adm.cmd.claim.chunkunload.all", parentName = "Empires.adm.cmd.claim.chunkunload", syntax = "/empireadmin claim chunkunload all <empire>", completionKeys = {
			"empireCompletion" })
	...
	@Command(name = "unclaim", permission = "Empires.adm.cmd.unclaim", parentName = "Empires.adm.cmd", syntax = "/empireadmin unclaim")
	public static CommandResponse unclaimCommand(ICommandSender sender, List<String> args) {
		...
		ChatManager.send(sender, "Empires.notification.block.removed", block.getX() << 4, block.getZ() << 4,
				(block.getX() << 4) + 15, (block.getZ() << 4) + 15, empire);
		return CommandResponse.DONE;
	}

	@Command(name = "help", permission = "Empires.adm.cmd.help", parentName = "Empires.adm.cmd", syntax = "/empireadmin help <command>", alias = {
			"?", "h" }, console = true)
	...
	@Command(name = "syntax", permission = "Empires.adm.cmd.syntax", parentName = "Empires.adm.cmd", syntax = "/empireadmin syntax <command>", console = true)
	...
	@Command(name = "debug", permission = "Empires.adm.cmd.debug", parentName = "Empires.adm.cmd", syntax = "/empireadmin debug <command>", console = false)
	public static CommandResponse debugCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "itemClass", permission = "Empires.adm.cmd.debug.item", parentName = "Empires.adm.cmd.debug", syntax = "/empireadmin debug itemClass", console = false)
	public static CommandResponse debugItemCommand(ICommandSender sender, List<String> args) {
		if (sender instanceof EntityPlayer) {
			...
			if (player.inventory.getCurrentItem() != null) {
				...
				if (player.inventory.getCurrentItem().getItem() instanceof ItemBlock) {
					...
					if (block instanceof ITileEntityProvider) {
						TileEntity te = ((ITileEntityProvider) block)
								.createNewTileEntity(MinecraftServer.getServer().worldServerForDimension(0), 0);
				...
				ChatManager.send(sender,
						new ChatComponentText("For item: " + player.inventory.getCurrentItem().getDisplayName()));
				for (Class cls : list) {
	...
	public static class Plots {
		@Command(name = "plot", permission = "Empires.adm.cmd.plot", parentName = "Empires.adm.cmd", syntax = "/empireadmin plot <command>", console = true)
		public static CommandResponse plotCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "show", permission = "Empires.adm.cmd.plot.show", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot show <empire>", completionKeys = {
				"empireCompletion" })
		...
		@Command(name = "perm", permission = "Empires.adm.cmd.plot.perm", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot perm <command>", console = true)
		public static CommandResponse plotPermCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "set", permission = "Empires.adm.cmd.plot.perm.set", parentName = "Empires.adm.cmd.plot.perm", syntax = "/empireadmin plot perm set <empire> <plot> <flag> <value>", completionKeys = {
				"empireCompletion", "plotCompletion", "flagCompletion" }, console = true)
		...
		@Command(name = "toggle", permission = "Empires.adm.cmd.plot.perm.toggle", parentName = "Empires.adm.cmd.plot.perm", syntax = "/empireadmin plot perm toggle <empire> <plot> <flag>", completionKeys = {
				"empireCompletion", "plotCompletion", "flagCompletion" }, console = true)
		...
		@Command(name = "list", permission = "Empires.adm.cmd.plot.perm.list", parentName = "Empires.adm.cmd.plot.perm", syntax = "/empireadmin plot perm list <empire> <plot>", completionKeys = {
				"empireCompletion", "plotCompletion" }, console = true)
		...
		@Command(name = "rename", permission = "Empires.adm.cmd.plot.rename", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot rename <empire> <plot> <name>", completionKeys = {
				"empireCompletion", "plotCompletion" }, console = true)
		...
		@Command(name = "add", permission = "Empires.adm.cmd.plot.add", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot add <command>", console = true)
		public static CommandResponse plotAddCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "owner", permission = "Empires.adm.cmd.plot.add.owner", parentName = "Empires.adm.cmd.plot.add", syntax = "/empireadmin plot add owner <empire> <plot> <citizen>", completionKeys = {
				"empireCompletion", "plotCompletion", "citizenCompletion" }, console = true)
		...
		@Command(name = "member", permission = "Empires.adm.cmd.plot.add.member", parentName = "Empires.adm.cmd.plot.add", syntax = "/empireadmin plot add member <empire> <plot> <citizen>", completionKeys = {
				"empireCompletion", "plotCompletion", "citizenCompletion" }, console = true)
		...
		@Command(name = "remove", permission = "Empires.adm.cmd.plot.remove", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot remove <empire> <plot> <citizen>", completionKeys = {
				"empireCompletion", "plotCompletion", "citizenCompletion" }, console = true)
		...
		@Command(name = "info", permission = "Empires.adm.cmd.plot.info", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot info <empire> <plot>", completionKeys = {
				"empireCompletion", "plotCompletion" }, console = true)
		public static CommandResponse plotInfoCommand(ICommandSender sender, List<String> args) {
			...
			IChatComponent header = LocalizationManager.get("Empires.format.list.header",
					new ChatComponentFormatted("{9|%s}", plot.getName()));
			ChatManager.send(sender, "Empires.format.plot.long", plot.ownersContainer, plot.toVolume().toChatMessage());
			return CommandResponse.DONE;
		}

		@Command(name = "delete", permission = "Empires.adm.cmd.plot.delete", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot delete <empire> <plot>", completionKeys = {
				"empireCompletion", "plotCompletion" }, console = true)
		...
		@Command(name = "hide", permission = "Empires.adm.cmd.plot.hide", parentName = "Empires.adm.cmd.plot", syntax = "/empireadmin plot hide")
	...
	@Command(name = "borders", permission = "Empires.adm.cmd.borders", parentName = "Empires.adm.cmd", syntax = "/empireadmin borders <command>")
	public static CommandResponse bordersCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "show", permission = "Empires.adm.cmd.borders.show", parentName = "Empires.adm.cmd.borders", syntax = "/empireadmin borders show <empire>", completionKeys = {
			"empireCompletion" })
	...
	@Command(name = "hide", permission = "Empires.adm.cmd.borders.hide", parentName = "Empires.adm.cmd.borders", syntax = "/empireadmin borders hide")
	...
	@Command(name = "rename", permission = "Empires.adm.cmd.rename", parentName = "Empires.adm.cmd", syntax = "/empireadmin rename <empire> <name>", completionKeys = {
			"empireCompletion" }, console = true)
	...
	@Command(name = "spawn", permission = "Empires.adm.cmd.spawn", parentName = "Empires.adm.cmd", syntax = "/empireadmin spawn <empire>", completionKeys = {
			"empireCompletion" }, console = true)

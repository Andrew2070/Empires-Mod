...
public class CommandsRecruit extends CommandsEMP {
	...
	@Command(name = "Empire", permission = "Empires.cmd", alias = { "emp", "empire", "Empire",
			"Emp" }, syntax = "/empire <command>")
	public static CommandResponse empireCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "leave", permission = "Empires.cmd.everyone.leave", parentName = "Empires.cmd", syntax = "/empire leave [delete]")
	...
	@Command(name = "spawn", permission = "Empires.cmd.everyone.spawn", parentName = "Empires.cmd", syntax = "/empire spawn [empire]", completionKeys = {
			"empireCompletion" })
	public static CommandResponse spawnCommand(ICommandSender sender, List<String> args) {
		...
		if (!empire.hasPermission(res, FlagType.ENTER, empire.getSpawn().getDim(), (int) empire.getSpawn().getX(),
				(int) empire.getSpawn().getY(), (int) empire.getSpawn().getZ())) {
			throw new EmpiresCommandException("Empires.cmd.err.spawn.protected", empire);
		}

		if (res.getTeleportCooldown() > 0) {
			throw new EmpiresCommandException("Empires.cmd.err.spawn.cooldown", res.getTeleportCooldown(),
					res.getTeleportCooldown() / 20);
		}
	...
	// Command Removed:
	/*
	 * @Command( name = "select", permission = "Empires.cmd.everyone.select",
	 * parentName = "Empires.cmd", syntax = "/empire select <empire>",
	 * completionKeys = {"empireCompletion"}) public static CommandResponse
	 * selectCommand(ICommandSender sender, List<String> args) { if (args.size()
	 * < 1) { return CommandResponse.SEND_SYNTAX; } Citizen res =
	 * EmpiresUniverse.instance.getOrMakeCitizen(sender); Empire empire =
	 * getEmpireFromName(args.get(0)); if (!empire.citizensMap.containsKey(res))
	 * { throw new EmpiresCommandException("Empires.cmd.err.select.notCitizen",
	 * empire); } getDatasource().saveSelectedEmpire(res, empire);
	 * ChatManager.send(sender, "Empires.notification.empire.select", empire);
	 * return CommandResponse.DONE; }
	 * 
	 */
	@Command(name = "territory", permission = "Empires.cmd.everyone.blocks", parentName = "Empires.cmd", syntax = "/empire territory <command>")
	public static CommandResponse blocksCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.cmd.everyone.blocks.list", parentName = "Empires.cmd.everyone.blocks", syntax = "/empire territory list")
	public static CommandResponse blocksListCommand(ICommandSender sender, List<String> args) {
		...
		root.appendSibling(
				LocalizationManager.get("Empires.format.list.header", new ChatComponentFormatted("{9|CLAIMS}")));
	...
	@Command(name = "info", permission = "Empires.cmd.everyone.blocks.info", parentName = "Empires.cmd.everyone.blocks", syntax = "/empire territory info")
	public static CommandResponse blocksInfoCommand(ICommandSender sender, List<String> args) {
		...
		for (Citizen citizen : empire.citizensMap.keySet()) {
			extraBlocksSources.add(LocalizationManager.get("Empires.notification.blocks.info.extra", citizen,
					citizen.getExtraBlocks()));
		}
	...
	@Command(name = "perm", permission = "Empires.cmd.everyone.perm", parentName = "Empires.cmd", syntax = "/empire perm <command>")
	public static CommandResponse permCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.cmd.everyone.perm.list", parentName = "Empires.cmd.everyone.perm", syntax = "/empire perm list")
	...
	public static class Plots {
		...
		@Command(name = "perm", permission = "Empires.cmd.everyone.plot.perm", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot perm <command>")
		public static CommandResponse plotPermCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "set", permission = "Empires.cmd.everyone.plot.perm.set", parentName = "Empires.cmd.everyone.plot.perm", syntax = "/empire plot perm set <flag> <value>", completionKeys = {
				"flagCompletion" })
		...
		@Command(name = "toggle", permission = "Empires.cmd.everyone.plot.perm.toggle", parentName = "Empires.cmd.everyone.plot.perm", syntax = "/empire plot perm set <flag>", completionKeys = {
				"flagCompletion" })
		...
		@Command(name = "list", permission = "Empires.cmd.everyone.plot.perm.list", parentName = "Empires.cmd.everyone.plot.perm", syntax = "/empire plot perm list")
		...
		@Command(name = "whitelist", permission = "Empires.cmd.everyone.plot.perm.whitelist", parentName = "Empires.cmd.everyone.plot.perm", syntax = "/empire plot perm whitelist")
		...
		@Command(name = "plot", permission = "Empires.cmd.everyone.plot", parentName = "Empires.cmd", syntax = "/empire plot <command>")
		public static CommandResponse plotCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "rename", permission = "Empires.cmd.everyone.plot.rename", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot rename <name>")
		...
		@Command(name = "new", permission = "Empires.cmd.everyone.plot.new", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot new <plot>")
		...
		@Command(name = "select", permission = "Empires.cmd.everyone.plot.select", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot select <command>")
		public static CommandResponse plotSelectCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "reset", permission = "Empires.cmd.everyone.plot.select.reset", parentName = "Empires.cmd.everyone.plot.select", syntax = "/empire plot select reset")
		...
		@Command(name = "show", permission = "Empires.cmd.everyone.plot.show", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot show")
		...
		@Command(name = "hide", permission = "Empires.cmd.everyone.plot.hide", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot hide")
		...
		@Command(name = "add", permission = "Empires.cmd.everyone.plot.add", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot add <command>")
		public static CommandResponse plotAddCommand(ICommandSender sender, List<String> args) {
			return CommandResponse.SEND_HELP_MESSAGE;
		}

		@Command(name = "owner", permission = "Empires.cmd.everyone.plot.add.owner", parentName = "Empires.cmd.everyone.plot.add", syntax = "/empire plot add owner <citizen>", completionKeys = {
				"citizenCompletion" })
		...
		@Command(name = "member", permission = "Empires.cmd.everyone.plot.add.member", parentName = "Empires.cmd.everyone.plot.add", syntax = "/empire plot add member <citizen>", completionKeys = {
				"citizenCompletion" })
		...
		@Command(name = "remove", permission = "Empires.cmd.everyone.plot.remove", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot remove <citizen>", completionKeys = {
				"citizenCompletion" })
		...
		@Command(name = "info", permission = "Empires.cmd.everyone.plot.info", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot info")
		...
		@Command(name = "delete", permission = "Empires.cmd.everyone.plot.delete", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot delete")
		...
		@Command(name = "sell", permission = "Empires.cmd.everyone.plot.sell", parentName = "Empires.cmd.everyone.plot", syntax = "/empire plot sell <price>")
	...
	@Command(name = "ranks", permission = "Empires.cmd.everyone.ranks", parentName = "Empires.cmd", syntax = "/empire ranks <command>")
	public static CommandResponse ranksCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "list", permission = "Empires.cmd.everyone.ranks.list", parentName = "Empires.cmd.everyone.ranks", syntax = "/empire ranks list")
	public static CommandResponse listRanksCommand(ICommandSender sender, List<String> args) {
		...
		IChatComponent root = new ChatComponentList();
		root.appendSibling(
				LocalizationManager.get("Empires.format.list.header", new ChatComponentFormatted("{9|RANKS}")));
		for (Rank rank : empire.ranksContainer) {
			root.appendSibling(new ChatComponentFormatted("{7| - }").appendSibling(
					LocalizationManager.get("Empires.format.rank.long", rank.getName(), rank.getType())));
		}
	...
	@Command(name = "borders", permission = "Empires.cmd.everyone.borders", parentName = "Empires.cmd", syntax = "/empire borders <command>")
	public static CommandResponse bordersCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "show", permission = "Empires.cmd.everyone.borders.show", parentName = "Empires.cmd.everyone.borders", syntax = "/empire borders show")
	...
	@Command(name = "hide", permission = "Empires.cmd.everyone.borders.hide", parentName = "Empires.cmd.everyone.borders", syntax = "/empire borders hide")
	...
	@Command(name = "bank", permission = "Empires.cmd.everyone.bank", parentName = "Empires.cmd", syntax = "/empire bank <command>")
	public static CommandResponse bankCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "info", permission = "Empires.cmd.everyone.bank.info", parentName = "Empires.cmd.everyone.bank", syntax = "/empire bank info")
	public static CommandResponse bankAmountCommand(ICommandSender sender, List<String> args) {
		...
		ChatManager.send(sender, "Empires.notification.empire.bank.info",
				EconomyProxy.getCurrency(empire.bank.getAmount()),
				EconomyProxy.getCurrency(empire.bank.getNextPaymentAmount()));
		return CommandResponse.DONE;
	}

	@Command(name = "deposit", permission = "Empires.cmd.everyone.bank.deposit", parentName = "Empires.cmd.everyone.bank", syntax = "/empire bank deposit <amount>")
	...
	@Command(name = "wild", permission = "Empires.cmd.everyone.wild", parentName = "Empires.cmd", syntax = "/empire wild <command>")
	public static CommandResponse permWildCommand(ICommandSender sender, List<String> args) {
		return CommandResponse.SEND_HELP_MESSAGE;
	}

	@Command(name = "perm", permission = "Empires.cmd.everyone.wild.perm", parentName = "Empires.cmd.everyone.wild", syntax = "/empire wild perm")

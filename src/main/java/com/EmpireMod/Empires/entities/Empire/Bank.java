...
public class Bank {
    ...
    public void payUpkeep() {
        ...
        if(makePayment(amount)) {
            ...
            daysNotPaid++;
            empire.notifyEveryone(Empires.instance.LOCAL.getLocalization("Empires.notification.empire.upkeep.failed", Config.instance.upkeepEmpireDeletionDays.get() - daysNotPaid));
        }
    }
    ...
    public int getNextPaymentAmount() {
        return (Config.instance.costEmpireUpkeep.get() + Config.instance.costAdditionalUpkeep.get() * empire.empireBlocksContainer.size()) * (1 + daysNotPaid);
    }

package com.EmpireMod.Empires.entities.Flags;
...
public class FlagType<T> implements Comparable<FlagType<T>> {
	public static final FlagType<Boolean> ENTER, ACCESS, PICKUP, PVP, MOBS, ENTITIES, PVE, USAGE, ACTIVATE, FAKERS,
			MODIFY, EXPLOSIONS, RESTRICTIONS, NEARBY;
	...
	static {
		...
		ACCESS = new FlagType<Boolean>("ACCESS", false, true, Property.IN_EMPIRE, Property.IN_PLOT, Property.IN_WILD,
				Property.WHITELISTABLE);

		// Allows pickup of items.
		PICKUP = new FlagType<Boolean>("PICKUP", true, true, Property.IN_EMPIRE, Property.IN_PLOT, Property.IN_WILD,
				Property.WHITELISTABLE);
		...
		ENTITIES = new FlagType<Boolean>("ENTITIES", true, true, Property.IN_EMPIRE, Property.IN_PLOT,
				Property.IN_WILD);
		...
		// Allows the right-clicking of certain blocks, such as: Doors, Buttons,
		// Levers etc.
		ACTIVATE = new FlagType<Boolean>("ACTIVATE", false, true, Property.IN_EMPIRE, Property.IN_PLOT,
				Property.IN_WILD, Property.WHITELISTABLE);
		...
		// Allows explosions
		EXPLOSIONS = new FlagType<Boolean>("EXPLOSIONS", false, true, Property.IN_EMPIRE, Property.IN_PLOT,
				Property.IN_WILD);
	...
	private enum Property {
		IN_EMPIRE, IN_PLOT, IN_WILD, WHITELISTABLE
	}
	...
	public static class Serializer extends SerializerTemplate<FlagType> {
		...
		@Override
		public FlagType deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)

    ...
    private class SignGeneratorAdapter extends GeneratorAdapter {
        ...
        public void visitInsn(int opcode) {
            ...
            if(opcode == Opcodes.RETURN) {
                // Add: Empires.classtransformers.SignClassTransformer.<localMethodName>(this, arg1);
                // before the return statement
                super.visitVarInsn(Opcodes.ALOAD, 0);
                super.visitVarInsn(Opcodes.ALOAD, 1);
                super.visitMethodInsn(Opcodes.INVOKESTATIC,
                        "Empires/utils/SignClassTransformer", localMethodName, "(Ljava/lang/Object;Lnet/minecraft/nbt/NBTTagCompound;)V", false);
            }
